    ...
    <SafeAreaLayout variant="background">
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Typography variant="body" color="secondary">Vista completa de todas las alertas</Typography>
        </View>
        
        <Card style={styles.mapPlaceholder}>
          <MaterialCommunityIcons name="map" size={64} color="#9CA3AF" />
          <Typography variant="h3" className="mt-4">Mapa Interactivo</Typography>
        ...
        <View style={styles.legend}>
          <Typography variant="h3" className="mb-3">Leyenda</Typography>
...
const styles = StyleSheet.create({
  ...
  mapPlaceholder: { height: 300, justifyContent: 'center', alignItems: 'center', backgroundColor: '#F3F4F6' },
  legend: { marginTop: 24 },
